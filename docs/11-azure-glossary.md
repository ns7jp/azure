...
- サーバー構築エンジニアを目指す初心者が、**Azureの基礎用語を理解し、そのまま覚えられる**ことを目的にした用語集です。分野別に14カテゴリ、合計293語を収録しています。
...
| 5 | ネットワークの基礎 | 23 | Azure以前に必要なTCP/IPの言葉 |
...
| 11 | [バックアップ・可用性・障害対応](glossary/11-backup-dr.md) | 18 | 壊れたときに戻すための言葉 |
| 12 | [コスト管理](glossary/12-cost.md) | 16 | 課金で驚かないための言葉 |
| 13 | [IaCと開発ツール](glossary/13-iac.md) | 19 | 構成をコードで扱うための言葉 |
| 14 | [現場でよく使う仕事の言葉](glossary/14-workplace.md) | 24 | Azure用語ではないが必ず出てくる言葉 |
| 15 | [混同しやすい用語の対比](glossary/15-confusions.md) | 34 | 似た用語を「違い」で覚える |
