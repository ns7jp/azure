...
- サーバー構築エンジニアを目指す初心者が、**Azureの基礎用語を理解し、そのまま覚えられる**ことを目的にした用語集です。分野別に14カテゴリ、合計46語を収録しています。
...
| 節 | カテゴリ | 語数 | 一言でいうと |
|---|---|---:|---|
| 3 | [クラウドとAzureの基礎概念](glossary/03-cloud-basics.md) | 24 | クラウドで何を借りているのかが分かる |
